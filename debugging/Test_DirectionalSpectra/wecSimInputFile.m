...
waves.freqDepDirection.nBins = 50; 
waves.phaseSeed = 10;
%% Body Data
% Float
body(1) = bodyClass('1_WEC_Data_d1p10_IRR_AllDirections_0360.h5');               % Create the body(1) Variable, Set Location of Hydrodynamic Data File and Body Number Within this File.   
